...
<html lang="es-ES">
    ...
    <body>
        <form
            action="../PHP/UsuarioModificarPHP.php" method="get">
                    ...
                    <div class="container">
                        <div class="row gx-lg-5 align-items-center">
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                ...
                                <img src="../img/pick-list.png" alt="Paqueteria" width="420" height="350"></center>
                            ...
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                <div class="card">
                                    <div class="card-body py-5 px-md-5">
                                        <center><h3><span class="text-warning">Modificar Cuenta</span></h3></center>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <label class="form-label" for="Correo">Correo Elctronico</label>
                                        </div>
