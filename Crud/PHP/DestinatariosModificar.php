...
<html lang="es-ES">
    ...
    <body>
        <form
            action="../PHP/DestinatarioModificarPHP.php" method="get">
                        ...
                        <div class="row gx-lg-5 align-items-center">
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                <center>
                                    ...
                                    <img src="../img/shipping.png" alt="Paqueteria" width="420" height="350"></center>
                            ...
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                <div class="card">
                                    <div class="card-body py-5 px-md-5">
                                        <center>
                                            <h3>
                                                <span class="text-warning">Modificar Destinatario</span>
                                            </h3>
                                        </center>
